...
def registrar_proyecto():
    ...
    nuevo_proyecto = Proyecto(nombre, descripcion, ubicacion, cliente,dificultad,estado,fecha_creacion_objeto,fecha_inicio_proyecto, fecha_cierre_proyecto, duracion_estimada)
